...
void main() {
  group('BalanceFormatUtil.satoshiToReadableBitcoin', () {
    ...
    test('satoshiToReadableBitcoin - 자연수 케이스', () {
      ...
      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(0, forceEightDecimals: true),
          '0.0000 0000');

      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(100000000), '1'); // 1 BTC
      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(100000000, forceEightDecimals: true),
          '1.0000 0000');

      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(1000000000), '10'); // 10 BTC
      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(1000000000, forceEightDecimals: true),
          '10.0000 0000');

      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(10000000000), '100'); // 100 BTC
      expect(
          BalanceFormatUtil.formatSatoshiToReadableBitcoin(10000000000, forceEightDecimals: true),
          '100.0000 0000');
      ...
      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(100000000000000),
          '1,000,000'); // 1,000,000 BTC
      expect(
          BalanceFormatUtil.formatSatoshiToReadableBitcoin(100000000000000,
              forceEightDecimals: true),
          '1,000,000.0000 0000');
    });
    ...
    test('satoshiToReadableBitcoin - 소수점 4자리 미만 케이스', () {
      ...
      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(10000000, forceEightDecimals: true),
          '0.1000 0000');
      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(1000000, forceEightDecimals: true),
          '0.0100 0000');
      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(100000, forceEightDecimals: true),
          '0.0010 0000');
      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(10000, forceEightDecimals: true),
          '0.0001 0000');

      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(123000000),
          '1.23'); // 소수점 2자리(뒤에 0뺴고 출력)
    });
    ...
    test('satoshiToReadableBitcoin - 소수점 4자리 초과 케이스', () {
      ...
      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(1000, forceEightDecimals: true),
          '0.0000 1000');
      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(100, forceEightDecimals: true),
          '0.0000 0100');
      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(10, forceEightDecimals: true),
          '0.0000 0010');
      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(1, forceEightDecimals: true),
          '0.0000 0001');

      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(123456000),
          '1.2345 6000'); // 소수점 5자리(0 붙여서 출력)
      expect(BalanceFormatUtil.formatSatoshiToReadableBitcoin(1000000010),
          '10.0000 0010'); // 소수점 7자리(0 붙여서 출력)
    });
