...
The MIT license covers the source code only. It does not grant rights to the "Coconut Vault" or "Nonce Lab" names or logos — see [TRADEMARK.md](https://github.com/noncelab/coconut_wallet/blob/main/TRADEMARK.md) for the separate trademark and brand usage policy.
