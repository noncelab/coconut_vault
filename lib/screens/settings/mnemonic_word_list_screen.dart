    ...
    return Container(
      ...
      child: Center(
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(color: _searchbarFillColor, borderRadius: BorderRadius.circular(12.0)),
          child: TextField(
        ...
        Padding(
          ...
          child: Align(
            ...
            child: Text(
              ...
              style: CoconutTypography.body1_16.setColor(CoconutColors.black.withValues(alpha: 0.5)),
            ),
          ),
        ),
