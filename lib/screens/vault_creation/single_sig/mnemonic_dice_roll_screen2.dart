...
class MnemonicDiceRollScreen2 extends BaseMnemonicEntropyScreen {
  const MnemonicDiceRollScreen2({super.key, required super.entropyType});

  @override
  State<MnemonicDiceRollScreen2> createState() => _MnemonicDiceRollScreenState();
}

class _MnemonicDiceRollScreenState extends BaseMnemonicEntropyScreenState<MnemonicDiceRollScreen2> {
  @override
