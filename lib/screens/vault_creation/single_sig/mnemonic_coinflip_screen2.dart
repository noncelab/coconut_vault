...
class MnemonicCoinflipScreen2 extends BaseMnemonicEntropyScreen {
  const MnemonicCoinflipScreen2({super.key, required super.entropyType});

  @override
  State<MnemonicCoinflipScreen2> createState() => _MnemonicDiceRollScreenState();
}

class _MnemonicDiceRollScreenState extends BaseMnemonicEntropyScreenState<MnemonicCoinflipScreen2> {
  @override
