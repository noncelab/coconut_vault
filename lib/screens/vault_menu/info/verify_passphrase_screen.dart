...
class VerifyPassphraseScreen extends StatefulWidget {
  const VerifyPassphraseScreen({super.key});
                          ...
                          return FixedBottomButton(
                            onButtonClicked: () {
                              ...
                              CustomDialogs.showLoadingDialog(
                                  context, t.verify_passphrase_screen.loading_description);
                              Future.delayed(const Duration(seconds: 2), () {
                                if (!mounted) return;
                                Navigator.of(context).pop();
                                _isPassphraseVerified = true;
                                _isVerificationResultSuccess =
                                    _isVerificationResultSuccess ? false : true;
                                setState(() {});
                              });
                            },
          ...
          children: [
            ...
            Row(
              children: [
                ...
                const Spacer(),
                Text('000000000', style: CoconutTypography.body3_12.setColor(CoconutColors.black)),
              ],
            ),
            CoconutLayout.spacing_400h,
            Row(
              ...
              children: [
                ...
                if (_isVerificationResultSuccess)
                  Expanded(
                    child: Text(
                        'zpub6ASAVgeehLbnwdqV6UKMHVzgqAG8Gr6riv3Fxxpj8ksbH9ebxaEyBLZ85ySDhKiLDBrQSARLq1uNRts8RuJiHjaDMBU4Zn9h8LZNnBC5y4a',
