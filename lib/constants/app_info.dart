...
const RELEASE_DATE = '2024.10.23';
const COPYRIGHT_TEXT =
    '© 2024 Nonce Lab. Inc. in S.Korea.\nLicensed under the MIT License with Commons Clause.';
const LICENSE_URL =
    'https://github.com/noncelab/coconut_vault/blob/main/LICENSE.md';
const CONTRIBUTING_URL =
    'https://github.com/noncelab/coconut_vault/blob/main/CONTRIBUTING.md';
...
const EMAIL_SUBJECT = '[코코넛 볼트] 이용 관련 문의';
