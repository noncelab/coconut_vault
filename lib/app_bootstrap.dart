...
/// `main.dart`와 `main_lite.dart`의 공통 초기화 로직입니다.
///
/// `isLiteBuild`가 `true`면 라이트(서명 전용) 빌드로 동작하며,
/// 안전 저장 모드 마이그레이션 및 iOS Secure Storage 정리를 건너뜁니다.
Future<void> bootstrapApp({required bool isLiteBuild, required Widget app}) async {
  if (kReleaseMode) {
