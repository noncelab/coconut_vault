...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  late final TranslationsSelectMultisigQuoramScreenKr
      select_multisig_quoram_screen =
      TranslationsSelectMultisigQuoramScreenKr.internal(_root);
...
extension on Translations {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'select_multisig_quoram_screen.total_key_count':
        return '전체 키의 수';
      case 'select_multisig_quoram_screen.required_signature_count':
        return '필요한 서명 수';
      case 'select_multisig_quoram_screen.one_or_two_of_n':
        return '하나의 키를 분실하거나 키 보관자 중 한 명이 부재중이더라도 비트코인을 보낼 수 있어요.';
      case 'select_multisig_quoram_screen.n_of_n':
        return '모든 키가 있어야만 비트코인을 보낼 수 있어요. 단 하나의 키만 잃어버려도 자금에 접근할 수 없게 되니 분실에 각별히 신경써 주세요.';
      case 'select_multisig_quoram_screen.one_of_n':
