...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	late final TranslationsMultisigSetupScreenKr multisig_setup_screen = TranslationsMultisigSetupScreenKr.internal(_root);
...
class TranslationsSignedTransactionQrScreenKr {
	...
	String guide_singlesig({required Object name}) => '월렛의 \'${name} 지갑\'에서 만든 보내기 정보에 서명을 완료했어요. 월렛으로 아래 QR 코드를 스캔해 주세요.';
}
...
// Path: multisig_setup_screen
class TranslationsMultisigSetupScreenKr {
	TranslationsMultisigSetupScreenKr.internal(this._root);
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'singlesig_wallet': return '일반 지갑';
			...
			case 'psbt_scanner_screen.guide_singlesig': return '월렛에서 만든 보내기 정보를 스캔해 주세요. 반드시 지갑 이름이 같아야 해요.';
			...
			case 'app_info_screen.coconut_vault': return 'coconut_vuault';
			...
			case 'select_vault_type_screen.singlesig': return '하나의 니모닉 문구를 보관하는 단일 서명 지갑이에요';
			...
			case 'multisig_setup_screen.edit_memo': return '메모 수정';
			case 'multisig_setup_screen.add_memo': return '메모 추가';
			case 'multisig_setup_screen.view_bsms': return '지갑 설정 정보 보기';
			case 'multisig_setup_screen.tooltip': return ({required Object total, required Object count}) => '${total}개의 키 중 ${count}개로 서명해야 하는\n다중 서명 지갑이예요.';
			...
			case 'errors.invalid_singlesig_qr_error': return '잘못된 QR이에요. 다시 시도해 주세요.';
			case 'errors.invalid_multisig_qr_error': return '잘못된 QR이예요.\n가져올 다중 서명 지갑의 정보 화면에서 "지갑 설정 정보 보기"에 나오는 QR 코드를 스캔해 주세요.';
