...
extension on Translations {
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'psbt_scanner_screen.guide_single_sig':
      ...
      case 'signed_transaction_qr_screen.guide_single_sig':
        return ({required Object name}) =>
            '월렛의 \'${name} 지갑\'에서 만든 보내기 정보에 서명을 완료했어요. 월렛으로 아래 QR 코드를 스캔해 주세요.';
      case 'single_sig_sign_screen.text':
        return '이미 서명된 트랜잭션입니다';
      case 'signer_qr_bottom_sheet.title':
        return '서명 트랜잭션 내보내기';
      ...
      case 'sync_to_wallet_screen.view_detail':
        return '상세 정보 보기';
      case 'vault_menu_screen.title.view_info':
        return ({required Object name}) => '${name} 정보';
      case 'vault_menu_screen.title.view_address':
        return '주소 보기';
      case 'vault_menu_screen.title.export_xpub':
        return '지갑 정보 내보내기';
      case 'vault_menu_screen.title.single_sig_sign':
        return '서명하기';
      case 'vault_menu_screen.title.multisig_sign':
        return '다중 서명하기';
      case 'vault_menu_screen.title.use_as_multisig_signer':
        return '다중 서명 키로 사용하기';
      case 'vault_menu_screen.title.import_bsms':
        return '다중 서명 지갑 가져오기';
      case 'vault_menu_screen.description.view_single_sig_info':
        return '저장된 니모닉 문구 등을 확인할 수 있어요';
      case 'vault_menu_screen.description.view_multisig_info':
        return '다중 서명 지갑의 정보를 확인할 수 있어요';
      case 'vault_menu_screen.description.import_bsms':
        return '이 키가 포함된 다중 서명 지갑 정보를 추가해요';
      case 'vault_menu_screen.description.view_address':
        return ({required Object name}) => '${name}의 주소를 확인해요';
      case 'vault_menu_screen.description.export_xpub':
        return '보기 전용 지갑을 월렛에 추가해요';
      case 'vault_menu_screen.description.sign':
        return '월렛에서 만든 정보를 스캔하고 서명해요';
      case 'vault_menu_screen.description.use_as_multisig_signer':
      ...
      case 'errors.remaining_times_away_from_reset_error':
        return ({required Object count}) => '초기화까지 ${count}번 남았어요';
      case 'errors.pin_max_attempts_exceeded_error':
        return '볼트를 잠금 해제할 수 없어요\n비밀번호를 초기화 한 후에 이용할 수 있어요';
