...
class SingleSigWalletInfoViewModel extends VaultSetupInfoViewModelBase<SingleSigVaultListItem> {
  ...
  SingleSigWalletInfoViewModel(super.walletProvider, super.id);
