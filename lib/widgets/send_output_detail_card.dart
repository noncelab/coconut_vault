...
import 'package:coconut_vault/widgets/send_ouput_detail_row.dart';
...
class _SendOutputDetailCardState extends State<SendOutputDetailCard> {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(20), color: CoconutColors.gray150),
        ...
        children: [
          Row(
            children: [
              Expanded(
                child: Text(
                  t.psbt_confirmation_screen.output_detail_title,
                  style: CoconutTypography.body3_12_Bold.copyWith(color: CoconutColors.gray900),
                ),
              ),
              GestureDetector(
                onTap: () {
              ...
              return Column(
                children: [
                  ...
                  if (!isLast) ...[
                    ...
                    const Divider(color: CoconutColors.gray300, height: 1),
                    const SizedBox(height: 16),
                  ],
                ],
              );
