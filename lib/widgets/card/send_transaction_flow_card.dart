...
class _SendTransactionFlowCardState extends State<SendTransactionFlowCard> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      decoration: BoxDecoration(borderRadius: BorderRadius.circular(24), color: CoconutColors.gray150),
  ...
  String _localizedInputTitle(BuildContext context, int index) {
    return t.psbt_confirmation_screen.flow_input_title(index: index);
  }

  String _localizedOutputTitle(BuildContext context, int index) {
    return t.psbt_confirmation_screen.flow_output_title(index: index);
  }
}
...
class _FlowNodeTile extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final titleStyle =
        isChange
            ? CoconutTypography.body2_14_Bold.copyWith(color: CoconutColors.cyan, height: 1.2)
            : CoconutTypography.body2_14.copyWith(color: CoconutColors.gray900, height: 1.2);

    final amountStyle =
        isChange
            ? CoconutTypography.caption_10_NumberBold.copyWith(color: CoconutColors.cyan, height: 1.2)
            : CoconutTypography.caption_10_Number.copyWith(color: CoconutColors.gray900, height: 1.2);
      ...
      child: SizedBox(
        ...
        child: Column(
          ...
          children: [
            Text(
              node.title,
              style: isEllipsis ? CoconutTypography.body1_16.copyWith(color: CoconutColors.gray400) : titleStyle,
            ),
