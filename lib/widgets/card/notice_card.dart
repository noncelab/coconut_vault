              ...
              Row(
                children: [
                  ...
                  Stack(
                    ...
                    children: [
                      Text(widget.title, style: CoconutTypography.body3_12_Bold.setColor(CoconutColors.gray600)),
                      Positioned(
                        top: -1,
                        right: -8,
                        child: Container(
                  ...
                  GestureDetector(
                    onTap: _dismiss,
                    child: const Icon(Icons.close, size: 18, color: CoconutColors.black),
                  ),
                ],
              ),
              const SizedBox(height: 12),
              Text(widget.description, style: CoconutTypography.body2_14_Bold.setColor(CoconutColors.black)),
              const SizedBox(height: 12),
              Align(
