...
class _QRCodeLinkInfoState extends State<QRCodeLinkInfo> {
  ...
  void initState() {
    super.initState();
    if (widget.qrData.contains('discord')) {
        ...
        children: [
          ...
          Stack(
            children: [
              Container(
                width: qrSize,
                height: qrSize,
                decoration: BoxDecoration(borderRadius: BorderRadius.circular(8), color: CoconutColors.white),
              ),
              QrImageView(
                data: widget.qrData,
          ...
          widget.qrData.contains('@')
              ? widget.qrData.contains(t.license)
                  ...
                  : Text(t.scan_qr_email_link, style: CoconutTypography.body1_16, textAlign: TextAlign.center)
              : Text(t.scan_qr_url_link, style: CoconutTypography.body1_16, textAlign: TextAlign.center),
        ],
      ),
    );
  }
