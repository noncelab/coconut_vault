...
void main() {
  ...
  group('UpdatePreparation Integration Tests', () {
    ...
    testWidgets('Full Update preparation process test', (tester) async {
      // Given
      //var result = await _walletProvider.createBackupData();를 대체하는 testData
      const testData = '''
      ...
      // validatePreparationState() 호출 시 에러가 발생하지 않는지 확인
